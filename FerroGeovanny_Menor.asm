...
main:
    ...
    li $t3, 2147483647    # valor más alto posible para inicializar el menor
...
ask_numbers:
    ...
    # Comparar si es menor que el actual menor
...
update_min:
    ...
    move $a0, $t3         # mover número menor a $a0
    syscall
